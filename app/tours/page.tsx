...
export default async function Tours({searchParams}:{searchParams:Promise<{categoria?:string;destino?:string}>}){
  ...
  const destinations=[{name:'Boquete',slug:'boquete'},{name:'Chiriquí',slug:'chiriqui'},{name:'Pedasí',slug:'pedasi'}];
